    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                ...
                <br />
                <div className="captioned-image">
                    <img src={ibmImage} style={styles.image} alt="IBM Cybersecurity Tools Certificate" />
                    <p>
                        <sub>
                            <b>Figure 3:</b> IBM Cybersecurity Tools & Cyberattacks - 2024
                        </sub>
                    </p>
                </div>
                <p>
            ...
            <div className="text-block">
                ...
                <p>
                    This one pulled me deep into the minds of threat actors. I learned how to trace attacks, analyze patterns, and turn raw data into actionable insights. It felt like solving a puzzle where every piece tells a story. The stakes were high, and the clock was always ticking. I loved every minute of it.
                </p>
            </div>
        </div>
    );
